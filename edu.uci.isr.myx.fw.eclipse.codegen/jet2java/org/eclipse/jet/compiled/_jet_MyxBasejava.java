...
import java.util.*;
import edu.uci.isr.myx2.eclipse.codegen.util.*;
import edu.uci.isr.myx2.eclipse.codegen.brick.*;
import edu.uci.isr.myx2.eclipse.codegen.codegen.BaseTemplateUtil;
 ...
 // in-brick interface variables getter
  ...
  // implemented methods of out brick interfaces
    for(CodegenBrickInterface repSig : BaseTemplateUtil.getImplMethodOut(brick)) {
        ...
        out.write("\t/* (non-Javadoc)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx2.fw.IMyxDynamicBrick#interfaceConnected(edu.uci.isr.myx2.fw.IMyxName, java.lang.Object)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t/**");  //$NON-NLS-1$        
  ...
  // out-single variables
    for(CodegenBrickInterface intf : BaseTemplateUtil.getOutSingleMyxVariables(brick)) {
        ...
        out.write("\t/* (non-Javadoc)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx.fw.IMyxDynamicBrick#interfaceDisconnecting(edu.uci.isr.myx.fw.IMyxName, java.lang.Object)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t/**");  //$NON-NLS-1$        
  ...
  // out-single variables
    for(CodegenBrickInterface intf : BaseTemplateUtil.getOutSingleMyxVariables(brick)) {
        ...
        out.write("\t/* (non-Javadoc)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx.fw.IMyxDynamicBrick#interfaceDisconnected(edu.uci.isr.myx.fw.IMyxName, java.lang.Object)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t/**");  //$NON-NLS-1$        
        ...
        out.write("\t/* (non-Javadoc)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx.fw.IMyxProvidedServiceProvider#getServiceObject(edu.uci.isr.myx.fw.IMyxName)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t/**");  //$NON-NLS-1$        
...
if(BaseTemplateUtil.shouldCreateMyxRegistry(brick)) {
	...
	for(CodegenBrickInterface intf : BaseTemplateUtil.getImplMethodDelegateToMyxRegistry(brick)) {
        ...
        out.write("\t/* (non-Javadoc)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx.fw.IMyxLifecycleProcessor#begin()");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t/**");  //$NON-NLS-1$        
...
if(BaseTemplateUtil.shouldCreateMyxRegistry(brick)){
        ...
        out.write("\t/* (non-Javadoc)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx.fw.IMyxLifecycleProcessor#destroy()");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t/**");  //$NON-NLS-1$        
        ...
        out.write("\t/* (non-Javadoc)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx.fw.IMyxLifecycleProcessor#end()");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t/**");  //$NON-NLS-1$        
...
if(BaseTemplateUtil.shouldCreateMyxRegistry(brick)){
        ...
        out.write("\t/* (non-Javadoc)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx.fw.IMyxLifecycleProcessor#init()");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t/**");  //$NON-NLS-1$        
  ...
  //methods that will be avaialble in init()
	...
	if(!brick.hasParentBrick()) {
        ...
        out.write("\t/* (non-Javadoc)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx.fw.IMyxBrick#setMyxBrickItems()");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t/**");  //$NON-NLS-1$        
        ...
        out.write("\t/* (non-Javadoc)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx.fw.IMyxBrick#getLifecycleProcessors()");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t/**");  //$NON-NLS-1$        
        ...
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\tpublic final IMyxLifecycleProcessor[] getLifecycleProcessors(){");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\treturn myxLifecycleProcessors.toArray(new IMyxLifecycleProcessor[myxLifecycleProcessors.size()]);");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t}");  //$NON-NLS-1$        
        out.write(NL);         
        out.write(NL);         
        out.write("\t/* (non-Javadoc)");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx.fw.IMyxBrick#getProvidedServiceProvider()");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t/**");  //$NON-NLS-1$        
