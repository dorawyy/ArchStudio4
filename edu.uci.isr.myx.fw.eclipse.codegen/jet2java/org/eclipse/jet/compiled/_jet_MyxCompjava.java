...
import edu.uci.isr.myx2.eclipse.codegen.codegen.CompTemplateUtil;
...
public class _jet_MyxCompjava implements JET2Template {
 ...
 // connectBeforeBegin 
        ...
        out.write("\t * @see edu.uci.isr.myx.fw.AbstractMyxSimpleBrick#init()");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
  	...
  	//variables that must be assigned values in init()
        ...
        out.write("\t/**");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t * @see edu.uci.isr.myx.fw.AbstractMyxSimpleBrick#begin()");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t */");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t @Override");  //$NON-NLS-1$        
