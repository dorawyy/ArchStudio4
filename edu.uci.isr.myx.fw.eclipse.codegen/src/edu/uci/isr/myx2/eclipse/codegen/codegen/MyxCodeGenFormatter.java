...
public class MyxCodeGenFormatter {
	...
	/**
	 * file name of the code formatter style
	 * TODO: temporary 
	 */
	...
	static void formatCode(IFile file) {
		...
		TextEdit edit = codeFormatter.format(
				CodeFormatter.K_COMPILATION_UNIT, // removed for 3.3: | CodeFormatter.F_INCLUDE_COMMENTS,
...
//						}
			...
			//formatterFileName = "/Users/nobuyukitakeo/Dev/eclipse342ws/myx2ArchStudio/edu.uci.isr.archstudio5.core/res/dev/ArchStudio Java Code Style Formatter-3.3.xml";
	...
	/**
	 * Sets the code formatter file name
	 * TODO: this is a temporary way until, Preferences ADT is used.
	 * @param fileName
	 */
