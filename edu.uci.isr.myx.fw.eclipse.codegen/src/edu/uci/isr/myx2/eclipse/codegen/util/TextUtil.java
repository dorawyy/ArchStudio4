package edu.uci.isr.myx2.eclipse.codegen.util;
...
public class TextUtil {
	 ...
	 * "Foo" will be returned from "edu.uci.foo.Foo".
	 * 
	 * @param javaFQClass
	 ...
	 * example, "edu.uci.isr.foo" will be returned from "edu.uci.foo.Foo".
	 * 
	 * @param javaFQClass
	 * @return
	 */
