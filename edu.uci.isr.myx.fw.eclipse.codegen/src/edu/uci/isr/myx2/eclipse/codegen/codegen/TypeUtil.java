...
class TypeUtil {
	...
	/**
	 * Recursively generates fully qualified class names from the given type
	 * signature and add them into the given set.
	 * 
	...
	/**
	 * Returns the collection of fully qualified class names from the given type
	 * signature.
	 * Ex. typeSignature = "QCollection<QString;>;" results in [java.lang.String, java.util.Collection].
	 * @param typeSignature
	...
	/**
	 * Returns the resolved fully qualified type. If there are more than one
	 * candidates, returns the first one. Ignores parameters of the given
	 * signature. For example, if the given type signature is "QFoo&lt;QBoo&gt;"
	 * , &lt;QBoo&gt; will be ignored.
	 * 
	 * @param sigInterfaceType
	 * @param typeSignature
	...
	/**
	 * Returns the resolved qualifier. If there are more than one candidates,
	 * returns the first one. Returns null if there is no candidate.
	 * 
	 * @param sigInterfaceType
	 * @param typeName
	 * @return
	...
	/**
	 * Returns string expression of default return value of the given signature
	 * type
	 * 
	 * @param signatureType
	 *            signature type defined at org.eclipse.jdt.core.Signature
	...
	public static void main(String[] args) {
		...
		// "Map"
		System.out.println("    getSignatureSimpleName(getTypeErasure):" + Signature.getSignatureSimpleName(Signature.getTypeErasure(typeSig)));
