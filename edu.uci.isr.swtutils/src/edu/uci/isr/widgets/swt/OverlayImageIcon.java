...
/**
 * @author Eric Dashofy, based on code from balajik@ibm This class is used for
 *         overlaying image icons
 */
public class OverlayImageIcon extends CompositeImageDescriptor {
	 ...
	 */
	private final int[] imageKey_;

	/**
	 * Image instance
	 */
	private final Image[] overlayImage_;
