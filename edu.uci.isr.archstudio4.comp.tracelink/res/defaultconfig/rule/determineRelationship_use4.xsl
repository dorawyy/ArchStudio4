	   ...
	   <xsl:otherwise>
			...
			<xsl:choose>
			  <xsl:when test="contains($curFileType, 'ppt')">
				  <xsl:choose>
					  <xsl:when test="contains($curFileType, 'jpg')">
			  ...
			  <xsl:when test="contains($curFileType, 'htm') or contains($curFileType, 'php') or contains($curFileType, 'txt')">
	            <xsl:value-of select="string('rationalization')"/>
			  </xsl:when>
			  
			  <xsl:when test="contains($curFileType, 'doc')">
			    <xsl:value-of select="string('satisfaction')"/>
			  </xsl:when>
				
			  <xsl:when test="contains($curFileType, 'pdf')">
