...
public class Interface extends ExtensionPointLocation implements IInterface {
	...
	private static final String ATTR_JAVA_INTERFACE = "javaInterface";
	...
	/*
	 * (non-Javadoc)
	 * @see edu.uci.isr.myx2.eclipse.extension.IInterface#getId()
	 */
	public String getId() {
		return id;
	}
	...
	/*
	 * (non-Javadoc)
	 * @see edu.uci.isr.myx2.eclipse.extension.IInterface#getName()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see edu.uci.isr.myx2.eclipse.extension.IInterface#getDirection()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see edu.uci.isr.myx2.eclipse.extension.IInterface#getConnectionTiming()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see edu.uci.isr.myx2.eclipse.extension.IInterface#getTemplateType()
	 */
	 ...
	 * (non-Javadoc)
	 * @see
	 * edu.uci.isr.myx2.eclipse.extension.IInterface#getFQJavaInterfaceName()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see edu.uci.isr.myx2.eclipse.extension.IInterface#getDescription()
	 */
