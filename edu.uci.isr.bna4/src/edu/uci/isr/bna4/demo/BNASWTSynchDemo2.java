...
public class BNASWTSynchDemo2 {
	...
	public BNASWTSynchDemo2() {
		...
		box.getBoxGlassThing().setBoundingBox(DefaultCoordinateMapper.DEFAULT_WORLD_WIDTH / 2 + 20, DefaultCoordinateMapper.DEFAULT_WORLD_HEIGHT / 2 + 20, 100,
		        100);
		...
		classBox.getBoxGlassThing().setBoundingBox(DefaultCoordinateMapper.DEFAULT_WORLD_WIDTH / 2 + 20, DefaultCoordinateMapper.DEFAULT_WORLD_HEIGHT / 2 + 20,
		        100, 100);
