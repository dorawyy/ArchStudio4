...
public class MirrorEndpointLogic extends AbstractMaintainThingsWithReferenceNameLogic<IHasEndpoints, IHasMutableAnchorPoint> {
	...
	public MirrorEndpointLogic(ReferenceTrackingLogic rtl) {
		super(IHasEndpoints.class, new String[] { IHasEndpoints.ENDPOINT_1_PROPERTY_NAME, IHasEndpoints.ENDPOINT_2_PROPERTY_NAME,
		        IHasMidpoints.MIDPOINTS_PROPERTY_NAME }, IHasMutableAnchorPoint.class, new String[] { IHasAnchorPoint.ANCHOR_POINT_PROPERTY_NAME,
