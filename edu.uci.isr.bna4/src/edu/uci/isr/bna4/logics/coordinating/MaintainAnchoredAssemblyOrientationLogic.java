...
public class MaintainAnchoredAssemblyOrientationLogic extends AbstractMaintainThingsWithReferenceNameLogic<IHasBoundingBox, IHasAnchorPoint> {
	...
	public MaintainAnchoredAssemblyOrientationLogic(ReferenceTrackingLogic rtl) {
		super(IHasBoundingBox.class, new String[] { IHasBoundingBox.BOUNDING_BOX_PROPERTY_NAME }, IHasAnchorPoint.class, new String[] {
		        IHasOrientation.ORIENTATION_PROPERTY_NAME, IHasAnchorPoint.ANCHOR_POINT_PROPERTY_NAME }, rtl, MaintainStickyPointLogic
		        .getReferenceName(IHasAnchorPoint.ANCHOR_POINT_PROPERTY_NAME));
	}
