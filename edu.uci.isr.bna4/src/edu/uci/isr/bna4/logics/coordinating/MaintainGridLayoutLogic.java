...
public class MaintainGridLayoutLogic extends AbstractMaintainThingsLogic<IHasBoundingBox, IHasMutableBoundingBox> {
	...
	public MaintainGridLayoutLogic() {
		super(IHasBoundingBox.class, new String[] { IHasBoundingBox.BOUNDING_BOX_PROPERTY_NAME, GRID_MASTER_DATA_PROPERTY_NAME }, IHasMutableBoundingBox.class,
		        new String[] { GRID_DATA_PROPERTY_NAME });
	}
