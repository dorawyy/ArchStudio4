...
public class MirrorBoundingBoxLogic extends AbstractMaintainThingsWithReferenceNameLogic<IHasBoundingBox, IHasMutableBoundingBox> {
	...
	public MirrorBoundingBoxLogic(ReferenceTrackingLogic rtl) {
		super(IHasBoundingBox.class, new String[] { IHasBoundingBox.BOUNDING_BOX_PROPERTY_NAME }, IHasMutableBoundingBox.class, new String[] {
		        IHasBoundingBox.BOUNDING_BOX_PROPERTY_NAME, BOUNDING_BOX_MIRROR_OFFSETS_PROPETY_NAME }, rtl, BOUNDING_BOX_MASTER_THING_ID_PROPERTY_NAME);
	}
