...
public class MaintainInternalWorldMappingsLogic extends AbstractMaintainThingsWithReferenceNameLogic<IHasWorld, IHasInternalWorldMapping> implements
	...
	public MaintainInternalWorldMappingsLogic(ReferenceTrackingLogic rtl, ThingPropertyTrackingLogic tptl, InternalWorldEventsLogic iwel) {
		super(IHasWorld.class, new String[] {}, IHasInternalWorldMapping.class, new String[] { IHasInternalWorldEndpoint.INTERNAL_ENDPOINT_PROPERTY_NAME,
		        IHasInternalWorldMapping.INTERNAL_ENDPOINT_STUCK_TO_THING_ID_PROPERTY_NAME }, rtl,
		        IHasInternalWorldEndpoint.INTERNAL_ENDPOINT_WORLD_THING_ID_PROPERTY_NAME);
		this.tptl = tptl;
		this.iwel = iwel;
	}
