...
public abstract class AbstractMaintainThingsWithReferencePrefixLogic<S extends IThing, T extends IThing> extends AbstractMaintainThingsLogic<S, T> {
	...
	public AbstractMaintainThingsWithReferencePrefixLogic(Class<? extends S> sourceClass, Object[] sourcePropertyNames, Class<? extends T> targetClass,
	        Object[] targetPropertyNames, ReferenceTrackingLogic rtl, ThingPropertyPrefixTrackingLogic tpptl, Object referencePropertyNamePrefix) {
