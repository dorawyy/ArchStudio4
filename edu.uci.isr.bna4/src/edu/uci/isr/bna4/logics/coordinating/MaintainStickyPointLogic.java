...
public class MaintainStickyPointLogic extends AbstractMaintainThingsWithReferencePrefixLogic<IThing, IThing> {
	...
	protected void maintain(IBNAModel sourceModel, IThing sourceThing, IThing targetThing, Object propertyName, ThingEvent thingEvent) {
		...
		try {
			...
			if (thingEvent != null && thingEvent.getTargetThing().equals(sourceThing) && sourceThing instanceof IHasBoundingBox
			        && IHasBoundingBox.BOUNDING_BOX_PROPERTY_NAME.equals(thingEvent.getPropertyName())) {
