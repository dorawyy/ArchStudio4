...
import edu.uci.isr.bna4.facets.IHasTargetThing;
...
public class MaintainTagsLogic extends AbstractMaintainThingsWithReferenceNameLogic<IThing, TagThing> {
	...
	public MaintainTagsLogic(ReferenceTrackingLogic rtl) {
		super(IThing.class, new String[] { SHOW_TAG_PROPERTY_NAME, IHasText.TEXT_PROPERTY_NAME }, TagThing.class, new String[] {}, rtl,
		        IHasTargetThing.TARGET_THING_ID_PROPERTY_NAME);
	}
	...
	protected void updateFromSource(IBNAModel sourceModel, IThing sourceThing, ThingEvent sourceThingEvent) {
		...
		if ((sourceThingEvent == null || sourceThingEvent.getPropertyName().equals(SHOW_TAG_PROPERTY_NAME))
		        && Boolean.TRUE.equals(sourceThing.getProperty(SHOW_TAG_PROPERTY_NAME))) {
