...
public class MirrorAnchorPointLogic extends AbstractMaintainThingsWithReferenceNameLogic<IHasAnchorPoint, IHasMutableAnchorPoint> {
	...
	public MirrorAnchorPointLogic(ReferenceTrackingLogic rtl) {
		super(IHasAnchorPoint.class, new String[] { IHasAnchorPoint.ANCHOR_POINT_PROPERTY_NAME }, IHasMutableAnchorPoint.class, new String[] {
		        IHasAnchorPoint.ANCHOR_POINT_PROPERTY_NAME, ANCHOR_POINT_MIRROR_OFFSETS_PROPETY_NAME }, rtl, ANCHOR_POINT_MASTER_THING_ID_PROPERTY_NAME);
	}
