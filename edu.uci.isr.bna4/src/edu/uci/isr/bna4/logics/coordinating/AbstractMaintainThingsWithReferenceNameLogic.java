...
public abstract class AbstractMaintainThingsWithReferenceNameLogic<S extends IThing, T extends IThing> extends AbstractMaintainThingsLogic<S, T> {

	protected final ReferenceTrackingLogic rtl;
	protected final Object referencePropertyName;

	public AbstractMaintainThingsWithReferenceNameLogic(Class<? extends S> sourceClass, Object[] sourcePropertyNames, Class<? extends T> targetClass,
	        Object[] targetPropertyNames, ReferenceTrackingLogic rtl, Object referencePropertyName) {
