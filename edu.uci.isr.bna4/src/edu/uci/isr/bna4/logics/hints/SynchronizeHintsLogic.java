...
public class SynchronizeHintsLogic extends AbstractThingLogic implements IBNASynchronousModelListener, IBNAModelListener, IBNAMouseListener,
	...
	public SynchronizeHintsLogic(final IHintRepository hintRepository) {
		...
		addHintSynchronizer(new PropertyHintSynchronizer(IHasMutableColor.class, IHasColor.COLOR_PROPERTY_NAME, IHasMutableColor.USER_MAY_EDIT_COLOR)
		        .addOldHintName("boxColor", "background"));
		addHintSynchronizer(new PropertyHintSynchronizer(IHasMutableBoundingBox.class, IHasBoundingBox.BOUNDING_BOX_PROPERTY_NAME,
		        IRelativeMovable.USER_MAY_MOVE).addOldHintName("glassBoundingBox", "glass"));
		addHintSynchronizer(new PropertyHintSynchronizer(IHasMutableAngle.class, IHasAngle.ANGLE_PROPERTY_NAME, IHasMutableAngle.USER_MAY_CHANGE_ANGLE));
		addHintSynchronizer(new PropertyHintSynchronizer(IHasMutableMidpoints.class, IHasMidpoints.MIDPOINTS_PROPERTY_NAME,
		...
		addHintSynchronizer(new PointHintSynchronizer(IHasMutableEndpoints.class, IHasEndpoints.ENDPOINT_1_PROPERTY_NAME,
		...
		addHintSynchronizer(new PointHintSynchronizer(IHasMutableEndpoints.class, IHasEndpoints.ENDPOINT_2_PROPERTY_NAME,
		...
		addHintSynchronizer(new PointHintSynchronizer(IHasMutableAnchorPoint.class, IHasAnchorPoint.ANCHOR_POINT_PROPERTY_NAME, IRelativeMovable.USER_MAY_MOVE)
