...
public class SelectionTrackingLogic extends AbstractThingLogic implements IBNAModelListener {
	...
	protected ListenerList<ISelectionTrackingListener> selectionTrackingListeners = new ListenerList<ISelectionTrackingListener>(
	        ISelectionTrackingListener.class);
