...
class DefaultThingLogicManager implements IThingLogicManager {
	...
	protected final ListenerList<IThingLogicManagerListener> listeners = new ListenerList<IThingLogicManagerListener>(ListenerList.IDENTITY,
	        IThingLogicManagerListener.class);
