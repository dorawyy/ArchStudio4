...
public interface IBNAView {
	...
	/**
	 * Setting this property value on a IThing to true makes the view obscure
	 * rendering of the thing.
	 */
	public static final String OBSCURE_THING_PROPERTY_NAME = "obscureThing";
