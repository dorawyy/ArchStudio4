...
public class BNAModelEvent {
	...
	public enum EventType {
		THING_ADDED(true), THING_REMOVING(true), THING_REMOVED(true), THING_CHANGED(true), THING_RESTACKED(true), BULK_CHANGE_BEGIN(false), BULK_CHANGE_END(false), STREAM_NOTIFICATION_EVENT(false);
		...
		private EventType(boolean pseudoEvent) {
	        this.modelModified = pseudoEvent;
        }
	};
